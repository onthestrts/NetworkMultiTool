...
def lookup_ip(ip):
    try:
        ...
        return {
            ...
            'region': res.get('network', {}).get('state', 'N/A'),
            'city': res.get('network', {}).get('city', 'N/A'),
            'postal_code': res.get('network', {}).get('postal_code', 'N/A'),
            'latitude': res.get('network', {}).get('latitude', 'N/A'),
            'longitude': res.get('network', {}).get('longitude', 'N/A'),
            'isp': res.get('network', {}).get('name', 'N/A'),
            'category': "Internet Technology"  # Example category, adjust as needed
        }
